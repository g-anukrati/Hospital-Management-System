...
//                   <p>
//                     <strong>Address:</strong>City Hospital Ansari Nagar East, Gautam Nagar, Ansari Nagar East, New Delhi, 110029
//                     Code
//                   </p>
//                   <p>
            ...
            <Row>
              ...
              <Col md={6}>
                <div className="contact-info">
                  <h3>Contact Information</h3>
                  <p>
                    <strong>Address:</strong> City Hospital,Delhi,India
                  </p>
                  <p>
                    <strong>Phone:</strong> +91 9837002025
                  </p>
                  <p>
                    <strong>Email:</strong> hospital@city.com
                  </p>
                  <p>
