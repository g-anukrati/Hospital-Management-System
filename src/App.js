    ...
    <>
      <div className="">
        ...
        <Switch>
          ...
          <Route
            exact
            path="/specialization-list-by-city"
            component={SpecializationListByCity}
          ></Route>
          <Route
            exact
            path="/current-app"
            component={ShowCurrentAppointment}
          ></Route>
          <Route
            exact
            path="/app-history"
          ...
          <Route
            exact
            path="/doctor-list-patient"
            component={DoctorListForPatient}
          ></Route>
          <Route
            exact
            path="/doctor-list-admin"
          ...
          <Route
            exact
            path="/SignUp-new-doctor"
            component={SignUpNewDoctor}
          ></Route>
          <Route exact path="/add-new-donor" component={AddNewDonor}></Route>
          <Route exact path="/donorList" component={DonorList}></Route>
          <Route
            exact
            path="/doctor-current-app"
            component={DoctorCurrentAppointments}
          ></Route>
          <Route
            exact
            path="/doctor-app-history"
            component={DoctorAppointmentHistory}
          ></Route>
          <Route
            exact
            path="/doctor-appointment-slots"
            component={DoctorAppointmentSlots}
          ></Route>
          <Route
            exact
            path="/create-appointment-slots"
            component={CreateAppointmentSlots}
          ></Route>
          <Route
            exact
            path="/book-slot-for-patient"
            component={BookSlotForPatient}
          ></Route>
          <Route
            exact
            path="/get-donors-by-city-and-blood-group"
            component={GetDonorsByCityAndBloodGroup}
          ></Route>
          <Route
            exact
          ...
          <Route
            exact
            path="/patient-details-for-doctor"
            component={PatientDetailsForDoctor}
          ></Route>
          <Route
            exact
            path="/show-appointment-slots-doctor"
            component={ShowAppointmentSlots}
          ></Route>
          <Route
            exact
            path="/doctor-details-for-patient"
            component={DoctorDetailsForPatient}
          ></Route>
